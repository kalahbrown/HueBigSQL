...
class Node(models.Model):
  ...
  def get_full_node(self):
    ...
    elif self.node_type == BigSQL.node_type:
      node = self.BigSQL
    else:
...
Action.types = (Mapreduce.node_type, Streaming.node_type, Java.node_type, Pig.node_type, Hive.node_type, Sqoop.node_type, Ssh.node_type, Shell.node_type, DistCp.node_type, Fs.node_type, Email.node_type, SubWorkflow.node_type, Generic.node_type, BigSQL.node_type)
