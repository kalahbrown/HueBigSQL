...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:workflow="uri:oozie:workflow:0.4" xmlns:bigsql="uri:oozie:bigsql-action:0.1" exclude-result-prefixes="workflow bigsql">
